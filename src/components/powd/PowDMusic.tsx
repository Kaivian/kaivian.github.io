          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-[#241A13] mt-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-2 text-xs font-mono tracking-wider rounded-xs border transition-all ${
                  currentPage === 1
              ...
              <div className="flex items-center gap-1">
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                  <button
                    ...
                    className={`w-8 h-8 flex items-center justify-center text-xs font-mono rounded-xs border transition-all cursor-pointer ${
                      currentPage === page
